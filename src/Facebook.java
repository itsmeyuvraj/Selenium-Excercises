...
public class Facebook {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@name='pass']")).sendKeys("example"); //locate password field and insert the password
		driver.findElement(By.xpath("//button[@name='login']")).click(); // locate and click login button
